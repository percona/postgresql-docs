...
We welcome contributors from all users and community. By contributing, you agree to the [Percona Community code of conduct :octicons-link-external-16:](https://github.com/percona/community/blob/main/content/contribute/coc.md).
...
1. **Request a doc change through a Jira issue**. If you’ve spotted a doc issue (a typo, broken links, inaccurate instructions, etc.) but don’t have time nor desire to fix it yourself - let us know about it.
	...
	- Click the **Submit DOC bug** link on the sidebar. This opens the [Jira issue tracker :octicons-link-external-16:](https://jira.percona.com/projects/DISTPG/issues) for the doc project.
...
- [Markdown :octicons-link-external-16:](https://www.markdownguide.org/basic-syntax/) markup language. It is used to write the documentation.
- [MkDocs :octicons-link-external-16:](https://www.mkdocs.org/getting-started/) documentation generator. We use it to convert source ``.md`` files to html and PDF documents.
- [git :octicons-link-external-16:](https://git-scm.com/) and [GitHub :octicons-link-external-16:](https://guides.github.com/activities/hello-world/)
- [Docker :octicons-link-external-16:](https://docs.docker.com/get-docker/). It allows you to run MkDocs in a virtual environment instead of installing it and its dependencies on your machine.
...
1. Click the **Edit this page** link on the sidebar. The Markdown file of the page opens in GitHub editor in your browser. If you haven’t worked with the repository before, GitHub creates a [fork :octicons-link-external-16:](https://docs.github.com/en/github/getting-started-with-github/fork-a-repo) of it for you.
...
1. [Get Docker :octicons-link-external-16:](https://docs.docker.com/get-docker/)
2. We use [this Docker image :octicons-link-external-16:](https://github.com/Percona-Lab/percona-doc-docker) to build documentation. Run the following command:
...
1. Install [pip :octicons-link-external-16:](https://pip.pypa.io/en/stable/installing/)
2. Install [MkDocs :octicons-link-external-16:](https://www.mkdocs.org/getting-started/#installation).
...
6. To build the PDF documentation, do the following:
   - Install [mkdocs-with-pdf plugin :octicons-link-external-16:](https://pypi.org/project/mkdocs-with-pdf/)
