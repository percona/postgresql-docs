...
This release of |pdp| is based on `PostgreSQL 12.7 <https://www.postgresql.org/docs/release/12.7/>`_.
...
.. list-table::
  ...
  * - `PostgreSQL contrib extensions <https://www.postgresql.org/docs/12/contrib.html>`_
    - 12.7
