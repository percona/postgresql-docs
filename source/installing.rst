...
This document provides installation instructions for |pdp| 12. For how to install the latest major version of |pdp|, see `Installing Percona Distribution for PostgreSQL 13 <https://www.percona.com/doc/postgresql/13/installing.html>`_.
...
As soon as |percona-release| is installed or up-to-date, enable the repository for |pdp| (``ppg-12``). We recommend using the *set up* command as it enables the specified repository and updates the platform's package manager database. 

.. code-block:: bash

   $ sudo percona-release setup ppg-12

To install a *specific minor version* of |pdp|, enable the Minor release repository. For example, to install |pdp| 12.5, enable the ``ppg-12.5``  repository using the following command:
...
Install the |percona-platform-postgresql-12| package using ``apt-get``.
