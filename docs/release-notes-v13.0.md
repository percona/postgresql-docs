...
This release of Percona Distribution for PostgreSQL is based on the latest major version of [PostgreSQL 13.0](https://www.postgresql.org/docs/release/13.0/). It also includes [pg_stat_monitor](https://github.com/percona/pg_stat_monitor) (Tech Preview Feature ) - a new statistics collection extension for PostgreSQL.
