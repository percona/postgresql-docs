# Percona Distribution for PostgreSQL 14.24 ({{date.14_24}})

[Installation](../installing.md){.md-button}

--8<-- "release-notes-intro.md"

This release of Percona Distribution for PostgreSQL is based on [PostgreSQL 14.24](https://www.postgresql.org/docs/14/release-14-24.html).
...
For more details, see the [PostgreSQL 14.24 release notes](https://www.postgresql.org/docs/14/release-14-24.html).
