...
This release of Percona Distribution for PostgreSQL is based on Percona Server for PostgreSQL 18.4.1 - a binary compatible, open source drop in replacement of [PostgreSQL Community 18.4](https://www.postgresql.org/docs/18/release-18-4.html).
...
!!! note
    `pg_tde` 2.2.0 requires Percona Distribution for PostgreSQL 18.4 at minimum. Earlier versions of PPG are not supported with this release of `pg_tde`.
