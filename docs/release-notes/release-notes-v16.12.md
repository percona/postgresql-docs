...
This release includes important security measures that address the following CVEs: CVE-2025-12817, CVE-2025-12818. For more details, see the PostgreSQL [16.11 release notes](https://www.postgresql.org/docs/16/release-16-12.html).
