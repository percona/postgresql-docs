# Percona Distribution for PostgreSQL 18.6.1 ({{date.18_6_1}})

--8<-- "release-notes-intro.md"

This release of Percona Distribution for PostgreSQL is based on Percona Server for PostgreSQL 18.6.1 - a binary compatible, open source drop in replacement of [PostgreSQL Community 18.6](https://www.postgresql.org/docs/18/release-18-6.html).
...
!!! note
    `pg_tde` 2.2.2 requires Percona Distribution for PostgreSQL 18.4.2 at minimum. Earlier versions of PPG are not supported with this release of `pg_tde`.
...
For more details, see the [PostgreSQL 18.6 release notes](https://www.postgresql.org/docs/18/release-18-6.html).
