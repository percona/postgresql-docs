# Percona Distribution for PostgreSQL 17.11.1 ({{date.17_11_1}})

--8<-- "release-notes-intro.md"

This release of Percona Distribution for PostgreSQL is based on Percona Server for PostgreSQL 17.11.1 - a binary compatible, open source drop in replacement of [PostgreSQL Community 17.11](https://www.postgresql.org/docs/17/release-17-11.html).
