...
This release includes important security measures that address the following CVEs: CVE-2025-8713, CVE-2025-8714, CVE-2025-8715. For more details, see the [PostgreSQL 16.11 release notes](https://www.postgresql.org/docs/release/16.11/).
