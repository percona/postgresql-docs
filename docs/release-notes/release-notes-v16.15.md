# Percona Distribution for PostgreSQL 16.15 ({{date.16_15}})

[Installation](../installing.md){.md-button}

--8<-- "release-notes-intro.md"

This release of Percona Distribution for PostgreSQL is based on [PostgreSQL 16.15](https://www.postgresql.org/docs/16/release-16-15.html).
...
For more details, see the [PostgreSQL 16.15 release notes](https://www.postgresql.org/docs/16/release-16-15.html).
...
| [PgAudit :octicons-link-external-16:](https://www.pgaudit.org/) | 16.1 | A detailed session or object audit logging via the standard logging facility provided by PostgreSQL |
