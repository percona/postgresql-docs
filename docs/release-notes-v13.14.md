# Percona Distribution for PostgreSQL 13.14 (2024-02-)
...
This release of Percona Distribution for PostgreSQL is based on [PostgreSQL 13.14](https://www.postgresql.org/docs/13/release-13-14.html).
