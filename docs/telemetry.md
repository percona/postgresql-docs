...
{"key" : "pillar_version","value" : "11.22"},
...
Starting with Percona Distribution for PostgreSQL 11.22, telemetry is enabled by default. If you decide not to send usage data to Percona, you can set the `PERCONA_TELEMETRY_DISABLE=1` environment variable for either the root user or in the operating system prior to the installation process.
