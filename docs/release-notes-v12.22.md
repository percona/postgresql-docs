# Percona Distribution for PostgreSQL 12.22 ({{date.12_22}})
...
This release of Percona Distribution for PostgreSQL is based on [PostgreSQL 12.22](https://www.postgresql.org/docs/release/12.22). 

## Release Highlights

* This is the last release of Percona Distribution for PostgreSQL 12.x as it enters end-of-life.

* This release includes fixes for [CVE-2024-10978](https://www.postgresql.org/support/security/CVE-2024-10978/) and for certain PostgreSQL extensions that break because they depend on the modified Application Binary Interface (ABI). These regressions were introduced in PostgreSQL 17.1, 16.5, 15.9, 14.14, 13.17, and 12.21. For this reason, the release of Percona Distribution for PostgreSQL 12.21 has been skipped. 
...
| [pgBackRest](https://pgbackrest.org/)           | 2.54    | a backup and restore solution for PostgreSQL       |
...
| [PostgreSQL Common](https://salsa.debian.org/postgresql/postgresql-common)| 266 | PostgreSQL database-cluster manager. It provides a structure under which multiple versions of PostgreSQL may be installed and/or multiple clusters maintained at one time.|
