# Percona Distribution for PostgreSQL 12.9
...
<table class="docutils field-list" frame="void" rules="none">
  ...
  <tbody valign="top">
    <tr class="field-odd field">
      ...
      <td class="field-body">December 13, 2021</td>
    </tr>
...
This release of Percona Distribution for PostgreSQL is based on [PostgreSQL 12.9](https://www.postgresql.org/docs/release/12.9/).
