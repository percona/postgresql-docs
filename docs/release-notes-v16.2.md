# Percona Distribution for PostgreSQL 16.2 (2024-02-)
...
| [pg_stat_monitor](https://github.com/percona/pg_stat_monitor)|2.0.5 | collects and aggregates statistics for PostgreSQL and provides histogram information.|
