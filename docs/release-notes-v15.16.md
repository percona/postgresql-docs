# Percona Distribution for PostgreSQL 15.16 ({{date.15_16}})

[Installation](installing.md){.md-button}

--8<-- "release-notes-intro.md"

This release of Percona Distribution for PostgreSQL is based on [PostgreSQL 15.16](https://www.postgresql.org/docs/current/release-15-16.html).
...
This release includes important security measures that address the following CVEs: CVE-2025-12817, CVE-2025-12818. For more details, see the PostgreSQL [15.15 release notes](https://www.postgresql.org/docs/15/release-15-16.html).
