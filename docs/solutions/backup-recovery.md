...
??? "**PostgreSQL disaster recovery options**"
    ...
    - **[pg_dump :octicons-link-external-16:](https://www.postgresql.org/docs/12/app-pgdump.html) or the [pg_dumpall :octicons-link-external-16:](https://www.postgresql.org/docs/12/app-pg-dumpall.html) utilities**

    This is the basic backup approach. These tools can generate the backup of one or more PostgreSQL databases (either just the structure, or both the structure and data), then restore them through the [pg_restore :octicons-link-external-16:](https://www.postgresql.org/docs/12/app-pgrestore.html) command. 
    ...
    - **PostgreSQL [pg_basebackup :octicons-link-external-16:](https://www.postgresql.org/docs/12/app-pgbasebackup.html)**
