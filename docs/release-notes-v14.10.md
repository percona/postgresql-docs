...
This release of Percona Distribution for PostgreSQL is based on [PostgreSQL 14.10](https://www.postgresql.org/docs/14/release-14-10.html). 
...
| ------------------- | -------------- | ---------------------------- |
|[HAProxy](https://www.haproxy.org/) | 2.8.3 | a high-availability and load-balancing solution |
